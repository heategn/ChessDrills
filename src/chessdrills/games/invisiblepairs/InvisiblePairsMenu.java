...
import chessdrills.games.GameMenu;
 ...
 */
public class InvisiblePairsMenu extends GameMenu{
    ...
    public InvisiblePairsMenu(GridPane gridLayout, ChessDrillsController cc, HashMap<Field, SimpleStringProperty> gameSettings){
        ...
        for(Field k : InvisiblePairsMenu.optionLabels.keySet()){
    ...
    private void addGameChoices(Field pieceType, String id){
        ...
        options[0] = "1";
        options[1] = "2";
        addGameChoices(pieceType, options, "1", id);
    }
