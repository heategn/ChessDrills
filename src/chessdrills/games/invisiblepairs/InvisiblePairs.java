...
import chessdrills.pieces.BishopData;
...
public class InvisiblePairs implements Game {
    ...
    public void start(ArrayList<Piece> pieces){
        ...
        //If the game was restarted after finishing a previous game, don't display the flash message again.
        if(currentState != GameState.INITIAL_RESTART){
            Board.setFlashText(flashText);
        }
...
//        3 = HashMap<Integer,Piece> pieceLocations
    ...
    public void end(boolean win){
        Board.show();
        Alert a;
        a = new Alert(Alert.AlertType.NONE, "Start again with same settings?");
